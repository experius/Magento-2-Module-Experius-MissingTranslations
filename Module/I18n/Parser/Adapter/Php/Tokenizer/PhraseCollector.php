 ...
 */
namespace Experius\MissingTranslations\Module\I18n\Parser\Adapter\Php\Tokenizer;

use Experius\MissingTranslations\Module\I18n\Parser\Adapter\Php\Tokenizer;
...
{
    /**
     * @var \Experius\MissingTranslations\Module\I18n\Parser\Adapter\Php\Tokenizer
     */
    ...
    protected function _collectPhrase($phraseTokens)
    {
        $phrase = [];
        if ($phraseTokens) {
            /** @var \Experius\MissingTranslations\Module\I18n\Parser\Adapter\Php\Tokenizer\Token $phraseToken */
